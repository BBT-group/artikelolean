                    ...
                    <div class="col-lg-8">
                        <?php if ($berita == null): ?>
                            <div class="alert alert-danger" role="alert">
                                Berita tidak ditemukan atau Berita tidak ada
                            </div>
                                ...
                                <div class="card" style="border: none; border-radius: 0;">
                                    <div class="card-body px-0 pt-0">
                                        ...
                                        <p class="card-text mt-2"><?= substr($item['deskripsi'], 0, 250); ?>...
                                            <span style="color: #EE002D; font-weight: bold; text-transform: uppercase; font-family: 'Oswald', sans-serif;"><a href="<?= 'isi_berita/' . $item['id_ms_berita'] ?>">Selengkapnya</a></span>
                                        </p>
                                    </div>
                                </div>
                            <?php endif; ?>
